    ...
    <script>
        $(function () {
            ...
            $("#dname").blur(function () {
                ...
                var res=/^[\u4e00-\u9fa5]{2,4}$/;
                if(res.test(dname)){
                    $(".checkDname").addClass("has-success").removeClass("has-error");
                    isdname=true;
                }else {
                    $(".checkDname").addClass("has-error").removeClass("has-success");
                    isdname=false;
                }
            })
...
<div class="container">
    ...
    <div class="row body">
        <form class="form-horizontal add" action="updateDept" method="post">
