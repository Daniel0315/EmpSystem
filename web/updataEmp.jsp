...
<div class="container">
    ...
    <div class="row body">
        <form class="form-horizontal add" action="updataEmp" method="post">
            ...
            <div class="form-group checkPhone">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="phone" placeholder="phone" name="phone" onkeyup="value=value.replace(/[^\d]/g,'')" value="${emp.phone}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label class="radio-inline">
                        ...
                        <input type="radio" name="sex" id="inlineRadio1" value="男" <c:if test="${emp.sex=='男'}">checked</c:if>> 男
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="sex" id="inlineRadio2" value="女" <c:if test="${emp.sex=='女'}">checked</c:if>> 女
                    </label>
            ...
            <div class="form-group checkSalary">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="salary" placeholder="salary" name="salary"  onkeyup="value=value.replace(/[^\d]/g,'')" value="${emp.salary}">
                </div>
            </div>
                ...
                <div class="col-sm-6">
                    <select class="form-control" name="dept_id">
                        <c:forEach items="${deptList}" var="dept">
                            <option value="${dept.dept_id}"  <c:if test="${dept.dept_id==emp.dept_id}">selected</c:if>>${dept.dname}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
